...
| ------------------ | ----------------- | ----------------------------------------------------------------------------------------------------- | --------------------------- |
| Anastasiia Khudych | Database Designer | Designed `members`, `memberships`, and `fitness_goals` tables and their relationships. https://drive.google.com/file/d/1wsj2Gq09B0dvTyBCI5Mb53ThPKv0KvRm/view?usp=drive_link               | ER diagram, database schema |
